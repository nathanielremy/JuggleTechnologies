...
class OnGoingTaskInteractionsHeaderCell: UICollectionViewCell {
    ...
    fileprivate func setupViews() {
        ...
        stackView.anchor(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 20, paddingBottom: 0, paddingRight: -20, width: nil, height: nil)
